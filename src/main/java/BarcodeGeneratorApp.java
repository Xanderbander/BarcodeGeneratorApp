...
public class BarcodeGeneratorApp extends JFrame implements ActionListener {
    ...
    public BarcodeGeneratorApp() {
        ...
        add(new JLabel("Height (DAU - in inches):"));
        ...
        add(new JLabel("Suffix (DCU):"));
        inputSuffix = new JTextField();
        add(inputSuffix);

        add(new JLabel("Weight (DAW - in pounds):"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String barcodeData = "@ANSI 636054090002DL00410301ZN03420053DLDAQ" + customerID
                            + "DCS" + lastName
                            + "DAC" + firstName
                            + "DAD" + middleName
                            + "DBB" + dob
